...
int main()
{
	...
	double pctRep = 100.0 * republicanSeats / republicanSeats;
	double pctDem = 100.0 * democraticSeats / democraticSeats;
	double pctInd = 100.0 * independentSeats / independentSeats;
